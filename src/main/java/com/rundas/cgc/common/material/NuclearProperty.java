 ...
 */
public record NuclearProperty(Material stableMaterial, Tuple<Material, Double> alphaDecay,
                              Tuple<Material, Double> betaPlusDecay, Tuple<Material, Double> betaMinusDecay,
                              boolean isFuel, boolean breedable)
